...
class Chi2Test(Test):
    ...
    @staticmethod
    def chi_stat(observed:NDArray, expected:NDArray)->tuple(float):
        """
...
class GapTest(Test):
    ...
    def test(self, data:NDArray,alpha:float=0.05,info:bool=False) -> float|Dict:
        ...
        # calcul des fréquences attendues pour chaque gap
...
k_r = 3
pattern_counts, expecteds = group_low_frequencies(S, k_r)
